...
public class absensi_ujian {
    ...
    */
    public boolean simpanAbsensi() {
        query = "INSERT INTO absensi_event VALUES (?,?,?,?,?)";
        try {
...
//            JOptionPane.showMessageDialog(null, "Data Gagal Disimpan ");
    ...
    public void autoID(JLabel idEvent) {
        try {
            String sql = "SELECT MAX(ID_absensi_event) FROM absensi_event";
    ...
    public String getIDregistrasi(String idEvent) {
        String idRegis = "";
        try {
